...
module.exports = class Server {
  ...
  */
  ...
  getFile(res, pathQuery) {
    const { cwd, config } = this;
    let rootPath = path.join(cwd, config.content_dir);
  ...
  */
  ...
  start() {
    ...
    api.get("/", (req, res) => {
      return res.sendFile(path.join(cwd, "lex-js/index.html"));
    });
    ...
    api.use("/public", express.static("lex-js/public"));
